...
#Use this command : unreal_engine.py_exec(r"D:\Repos\Piroots2\Other Files\ExportedFbx\ImportAssetScript.py")
	...
	def CreateTask_SK_Armature():
		...
		FilePath = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\SK_Armature.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\SK_Armature_AdditionalParameter.ini')
	...
	def CreateTask_Anim_Armature_ArmatureAction000():
		################[ Import Armature as Action type ]################
		print('================[ New import task : Armature as Action type ]================')
		FilePath = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\Anim\Anim_Armature_ArmatureAction000.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\Anim\SK_Armature_AdditionalParameter.ini')
	...
	CreateTask_Anim_Armature_ArmatureAction000()
	
	
	
	
	def CreateTask_Anim_Armature_ArmatureAction001():
		################[ Import Armature as Action type ]################
		print('================[ New import task : Armature as Action type ]================')
		FilePath = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\Anim\Anim_Armature_ArmatureAction001.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\Anim\SK_Armature_AdditionalParameter.ini')
		AssetImportPath = (os.path.join(unrealImportLocation, r'Anim').replace('\\','/')).rstrip('/')
		SkeletonLocation = os.path.join(unrealImportLocation, r'SK_Armature_Skeleton.SK_Armature_Skeleton').replace('\\','/')
		OriginSkeleton = ue.find_asset(SkeletonLocation)
		...
		asset.post_edit_change()
		ImportedList.append([asset, 'Action'])
	CreateTask_Anim_Armature_ArmatureAction001()
	
	
	
	
	def CreateTask_Anim_Armature_ArmatureAction002():
		################[ Import Armature as Action type ]################
		print('================[ New import task : Armature as Action type ]================')
		FilePath = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\Anim\Anim_Armature_ArmatureAction002.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\Anim\SK_Armature_AdditionalParameter.ini')
		AssetImportPath = (os.path.join(unrealImportLocation, r'Anim').replace('\\','/')).rstrip('/')
		SkeletonLocation = os.path.join(unrealImportLocation, r'SK_Armature_Skeleton.SK_Armature_Skeleton').replace('\\','/')
		OriginSkeleton = ue.find_asset(SkeletonLocation)
		...
		asset.post_edit_change()
		ImportedList.append([asset, 'Action'])
	CreateTask_Anim_Armature_ArmatureAction002()
	...
	def CreateTask_Anim_Armature_ArmatureAction003():
		################[ Import Armature as Action type ]################
		print('================[ New import task : Armature as Action type ]================')
		FilePath = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\Anim\Anim_Armature_ArmatureAction003.fbx')
		AdditionalParameterLoc = os.path.join(r'D:\Repos\Piroots2\Other Files\ExportedFbx\SkeletalMesh\Armature\Anim\SK_Armature_AdditionalParameter.ini')
		AssetImportPath = (os.path.join(unrealImportLocation, r'Anim').replace('\\','/')).rstrip('/')
		SkeletonLocation = os.path.join(unrealImportLocation, r'SK_Armature_Skeleton.SK_Armature_Skeleton').replace('\\','/')
		OriginSkeleton = ue.find_asset(SkeletonLocation)
		...
		asset.post_edit_change()
		ImportedList.append([asset, 'Action'])
	CreateTask_Anim_Armature_ArmatureAction003()
