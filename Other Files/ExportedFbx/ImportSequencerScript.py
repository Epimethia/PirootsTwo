...
#Use this command : unreal_engine.py_exec(r"D:\Repos\Piroots2\Other Files\ExportedFbx\ImportSequencerScript.py")
...
def CreateSequencer():
	...
	camera_cut_section.sequencer_set_section_range(8/frameRateNumerator, (43-secureCrop)/frameRateNumerator)
	#Import camera cut section
	camera_cut_section = camera_cut_track.sequencer_track_add_section()
	#Not camera found for this section
	camera_cut_section.sequencer_set_section_range(43/frameRateNumerator, (107-secureCrop)/frameRateNumerator)
	#Import camera cut section
	camera_cut_section = camera_cut_track.sequencer_track_add_section()
	#Not camera found for this section
	camera_cut_section.sequencer_set_section_range(107/frameRateNumerator, (125-secureCrop)/frameRateNumerator)
	#Import camera cut section
	camera_cut_section = camera_cut_track.sequencer_track_add_section()
	#Not camera found for this section
	camera_cut_section.sequencer_set_section_range(125/frameRateNumerator, (191-secureCrop)/frameRateNumerator)
	#Import camera cut section
	camera_cut_section = camera_cut_track.sequencer_track_add_section()
	#Not camera found for this section
	camera_cut_section.sequencer_set_section_range(191/frameRateNumerator, (221-secureCrop)/frameRateNumerator)
	#Import camera cut section
	camera_cut_section = camera_cut_track.sequencer_track_add_section()
	#Not camera found for this section
	camera_cut_section.sequencer_set_section_range(221/frameRateNumerator, (268-secureCrop)/frameRateNumerator)
	#Import camera cut section
	camera_cut_section = camera_cut_track.sequencer_track_add_section()
	#Not camera found for this section
	camera_cut_section.sequencer_set_section_range(268/frameRateNumerator, (269-secureCrop)/frameRateNumerator)
